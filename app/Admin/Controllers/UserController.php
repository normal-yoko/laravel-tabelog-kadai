...
//        $grid->column('password', __('Password'));
        $grid->column('paid_flg', __('Paid flg'));
...
//        $show->field('password', __('Password'));
        $show->field('paid_flg', __('Paid flg'));
  ...
  //      $show->field('deleted_at', __('Deleted at'));
    ...
    protected function form()
    {
        ...
        $form->date('email_verified_at', __('Email verified at'))->default(date('Y-m-d'));
        $form->password('password', __('Password'));
        $form->switch('paid_flg', __('Paid flg'));
